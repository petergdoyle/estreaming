...
read -e -p "Enter the JMS Connection Factory Provider Class: " -i "com.cleverfishsoftware.spring.xd.jms.sender.sample.ActiveMQConnectionFactoryProvider" connectionFactoryClassName
