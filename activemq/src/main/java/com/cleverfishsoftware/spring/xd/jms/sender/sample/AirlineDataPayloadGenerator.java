...
import com.cleverfishsoftware.spring.xd.jms.sender.Airline;
import com.cleverfishsoftware.spring.xd.jms.sender.Airport;
...
public class AirlineDataPayloadGenerator implements PayloadGenerator {
    ...
    static {
        try {
            ...
            in = com.cleverfishsoftware.spring.xd.jms.sender.MessageSender.class.getClassLoader().getResourceAsStream("airlines.dat");
            ...
            in = com.cleverfishsoftware.spring.xd.jms.sender.MessageSender.class.getClassLoader().getResourceAsStream("airports.dat");
            records = CSVFormat.DEFAULT.parse(new BufferedReader(new InputStreamReader(in)));
            for (CSVRecord each : records) {
            ...
            Logger.getLogger(com.cleverfishsoftware.spring.xd.jms.sender.MessageSender.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
